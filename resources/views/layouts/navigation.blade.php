<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-200">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('coffees.index')" :active="request()->routeIs('coffees.*')" class="text-white">
                        {{ __('Coffees') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('coffees.index')" :active="request()->routeIs('coffees.*')">
                {{ __('Coffees') }}
            </x-responsive-nav-link>
